...
@section('content')
               ...
               <div class="carousel-item active">
                  <div class="container">
                     <div class="row marginii">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                           <div class="img-box">
                              <figure><img src="assets/images/boksing-gloves.png" alt="img"/></figure>
                           </div>
                        </div>
                     </div>
                  </div>
            ...
            <div class="row">
               ...
               <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                  <div class="sport_product">
                     <figure><img src="{{asset('assets/images/' . $data->product_image)}}" alt="img"/></figure>
                    <h3> $<strong class="price_text">{{$data->product_price}}</strong></h3>
               ...
               <div class="carousel-item active">
                  <div class="container">
                     <div class="row marginii">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                           <div class="img-box">
                              <figure><img src="assets/images/child-image.png" style="max-width: 100%; border: 15px solid #fff;"/></figure>
                           </div>
                        </div>
                     </div>
                  </div>
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item {{$test->id == 1 ? 'active' : ''}}">
      <div class="titlepage">
                           <div class="john">
                              <div class="john_image"><img src="assets/images/john-image.png" style="max-width: 100%;"></div>
                              <div class="john_text">{{$test->testi_name}}<span style="color: #fffcf4;">({{$test->testi_jabatan}})</span></div>
                              <p class="lorem_ipsum_text">{{$test->testi_uraian}}</p>
               ...
               <div class="address_2">
                  <div class="row">
                     <div class="col-sm-12 col-md-12 col-lg-4">
                       <div class="site_info">
                          <span class="info_icon"><img src="assets/images/map-icon.png" /></span>
                          <span style="margin-top: 10px;">No.123 Chalingt Gates, Supper market New York</span></div>
                     </div>
                     <div class="col-sm-12 col-md-12 col-lg-4">
                       <div class="site_info">
                          <span class="info_icon"><img src="assets/images/phone-icon.png" /></span>
                          <span style="margin-top: 21px;">( +71 7986543234 )</span></div>
                     </div>
                     <div class="col-sm-12 col-md-12 col-lg-4">
                       <div class="site_info">
                          <span class="info_icon"><img src="assets/images/email-icon.png" /></span>
